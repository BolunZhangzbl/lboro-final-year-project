# -*- coding: utf-8 -*-
"""
Created on Fri Mar 12 16:37:16 2021
...
u1_deco1 = twouser_autoencoder.get_layer("u1_receiver")(u1_deco)
u1_decoder = Model(u1_encoded_input, u1_deco1)
...
u2_deco1 = twouser_autoencoder.get_layer("u2_receiver")(u2_deco)
u2_decoder = Model(u2_encoded_input, u2_deco1)
...
plt.legend(['user1(2,2), emb_k=2', 'user2(2,2), emb_k=2'], loc='upper right', fontsize = 12)
...
for n in range(0, len(EbNodB_range)):
    ...
    u2_no_errors = (u1_pred_output != test_label_s2)
...
plt.title('TwoUsers BLER (2,2) of U1, U2 and combined', fontsize=20)
plt.grid()

# -*- coding: utf-8 -*-
"""
Created on Tue Mar  9 22:40:30 2021
...
class NewAutoEncoder(object):
    """
    This is an API for the use of NN of an end to end communication system,the SNR in training process varies
...
plt.grid()
plt.show()"""
model_test3 = NewAutoEncoder(CodingMeth='Embedding',M = 16, n_channel=7, k = 4, emb_k=16, EbNodB_train = 7,train_data_size=10000)
model_test3.Initialize()
print("Initialization Finished")
#model_test3.Draw_Constellation()
model_test3.Cal_BLER(bertest_data_size= 70000)

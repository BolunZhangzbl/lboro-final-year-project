# -*- coding: utf-8 -*-
"""
Created on Thu Mar 11 11:07:57 2021
...
EbN0dB_range = list(np.linspace(-4, 8.5, 26))#EbNodB_range = list(np.linspace(0, 20, 21))
k=2
...
print("Initialization Finished")
#model_test3.Draw_Constellation() 'EbNodB_low=0, EbNodB_high=20, EbNodB_num=21,' 
model_test.Cal_BLER(bertest_data_size= 70000)
plt.plot(EbN0dB_range, model_test.ber, 'bo', label='AErayleigh(2,2)')

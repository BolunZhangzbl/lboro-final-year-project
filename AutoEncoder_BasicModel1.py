# -*- coding: utf-8 -*-
"""
Created on Mon Apr  5 15:45:17 2021
...
class AutoEncoder1(object):
    ...
    """
    def __init__(self, CodingMeth = 'Embedding',M = 4,n_channel = 7, k = 2, emb_k=4, EbNodB_train = 7 , train_data_size = 10000):
        """
    ...
    def Cal_BLER1(self, bertest_data_size = 50000, EbNodB_low = -4, EbNodB_high = 8.5, EbNodB_num = 26):
...
"""
model_test1 = AutoEncoder(CodingMeth='Embedding',M = 4, n_channel=2, k = 2, emb_k=4,EbNodB_train = 7,train_data_size=10000)
model_test2 = AutoEncoder(CodingMeth='Embedding',M = 16, n_channel=4, k = 4, emb_k=16,EbNodB_train = 7,train_data_size=10000)
model_test3 = AutoEncoder1(CodingMeth='Embedding',M = 4, n_channel=2, k = 2, emb_k=4,EbNodB_train = 7,train_data_size=10000)
model_test4 = AutoEncoder1(CodingMeth='Embedding',M = 16, n_channel=4, k = 4, emb_k=16,EbNodB_train = 7,train_data_size=10000)
model_test1.Initialize()
model_test2.Initialize()
model_test3.Initialize1()
model_test4.Initialize1()
print("Initialization Finished")
model_test1.Cal_BLER(bertest_data_size= 70000)
model_test2.Cal_BLER(bertest_data_size= 70000)
model_test3.Cal_BLER1(bertest_data_size= 70000)
model_test4.Cal_BLER1(bertest_data_size= 70000)
EbNodB_range = list(np.linspace(-4, 8.5, 26))
plt.plot(EbNodB_range, model_test1.ber,'k-', label='(2,2), fixed power constraint')
plt.plot(EbNodB_range, model_test2.ber,'k--', label='(4,4), fixed power constraint')
plt.plot(EbNodB_range, model_test3.ber,'bo', label='(2,2), average power constraint')
plt.plot(EbNodB_range, model_test4.ber,'ro', label='(4,4), average power constraint')
plt.yscale('log')
plt.title('BLER of (2,2) and (4,4) with different power constraint', fontsize=20)
plt.xlabel('Eb/No [dB]', fontsize=15)
